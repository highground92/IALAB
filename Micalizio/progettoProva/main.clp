...
(deftemplate city_goods_planning (slot id_cgp)(slot num)(slot city_departure)(slot city_arrival)
                                 (slot requested_goods_quantity)(slot requested_goods_type)
                                 (slot f_cost)(slot h_cost)(slot g_cost)(slot father)(slot type_route))
(deftemplate instruction_root (slot id_cgp)(slot num)(slot city_departure)(slot city_arrival)
                              (slot trans_goods_quantity)(slot type_route))
(deftemplate lastcity (slot id_last) (slot g_cost))
;(deftemplate transport (slot id_state)(slot id_transport)(slot transport_type)(slot type_route) ;Per il momento si assume un solo tipo di merci trasportato
...
(defrule print (declare(salience 50))
  (print)
  (lastcity (id_last ?last))
  (city_goods_planning(id_cgp ?id_city)(num ?last)(city_departure ?city_departure)
                              ...
                              (requested_goods_type ?rgt)(f_cost ?f)
                              (h_cost ?h)(g_cost ?g)(type_route ?type_route))
=>
  (printout t "La città " ?id_city " con last " ?last " ha richiesta " ?rgq " con costo " ?f " parte da " ?city_departure " e arriva a " ?arrival crlf)
