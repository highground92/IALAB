...
(deftemplate state_planning(slot id_transport)(slot id_city )(slot f_cost)(slot h_cost)(slot g_cost)(slot requested_goods_quantity)
...
(defrule stampa-soluzione (declare (salience 50)) ; Faccio le stampe(al contrario) del percorso
  ...
  (city (id_state ?id)(id_city Torino)(requested_goods_quantity ?requested_q1)(requested_goods_type ?requested_t1)
        ( provided_goods_quantity ?provided_g1)(provided_goods_type ?provided_t1))
  (city (id_state ?id)(id_city Genova)(requested_goods_quantity ?requested_q2)(requested_goods_type ?requested_t2)
        ( provided_goods_quantity ?provided_g2)(provided_goods_type ?provided_t2))
  (city (id_state ?id)(id_city Firenze)(requested_goods_quantity ?requested_q3)(requested_goods_type ?requested_t3)
        ( provided_goods_quantity ?provided_g3)(provided_goods_type ?provided_t3))
  (city (id_state ?id)(id_city Venezia)(requested_goods_quantity ?requested_q4)(requested_goods_type ?requested_t4)
        ( provided_goods_quantity ?provided_g4)(provided_goods_type ?provided_t4))
  (city (id_state ?id)(id_city Bologna)(requested_goods_quantity ?requested_q5)(requested_goods_type ?requested_t5)
        ( provided_goods_quantity ?provided_g5)(provided_goods_type ?provided_t5))
  (city (id_state ?id)(id_city Milano)(requested_goods_quantity ?requested_q6)(requested_goods_type ?requested_t6)
...
=>
  ...
  (printout t "trasporto 4 tipo " ?trans_type4 " goods " ?quantity4 " " ?g_type4 " citta " ?trans_city5  crlf)
  (printout t "trasporto 5 tipo " ?trans_type5 " goods " ?quantity5 " " ?g_type5 " citta " ?trans_city6  crlf)
...
?current<-(current (id_state ?id_current_state))
...
=>
(assert (stateplanning(id_transport ?id_truck)(f_cost 999999)(h_cost 9999999)(g_cost 9999999))) ; stubby che verrà rimpiazzato subito
...
?sp<-(stateplanning(id_transport ?id_truck))
(retract ?sp)
)
...
(defrule expand_truck_empty_cargo_city_with_goods
...
(defrule expand_truck_empty_cargo_city_with_no_goods
  (next_truck(id_truck ?id_trans))
  (state(id_state ?id_state)(f_cost ?f_cost)(h_cost ?h_cost)(g_cost ?g_cost))
  (transport (id_state ?id_state)(id_transport ?id_trans)(transport_type Truck)
             (type_route Ground)(goods_quantity 0)(goods_type NA)(city ?id_city))
...
=>
  (modify ?stateplanning (id_transport ?id_trans)(id_city ?arrival)
                         ...
                         (f_cost (+ ((* 20 ?km) ?fcostplanning) ?km))
                         (h_cost ((* 20 ?km) ?fcostplanning))
                         (g_cost ?km)
  )
)
...
?city <- (city(id_state ?id_current)(id_city ?id_city_arrival)(provided_goods_type ?prov_goods_type)(provided_goods_quantity ?prov_goods_q))
