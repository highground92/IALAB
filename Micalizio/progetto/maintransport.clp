...
=>
  (assert (state_planning(id_transport ?id_ship)(transport_type Ship)(f_cost 99999999)
                         (h_cost 99999999)(total_distance 99999999))) ; stubby che verrà rimpiazzato subito
  (focus LOAD)
)
...
=>
  (assert (state_planning(id_transport ?id_plane)(transport_type Plane)(f_cost 99999999)
                         (h_cost 99999999)(total_distance 99999999)))
  (focus LOAD)
)
...
=>
  (assert (state_planning(id_transport ?id_truck)(transport_type Truck)(f_cost 99999999)
                         (h_cost 99999999)(total_distance 99999999)))
  (focus LOAD)
)
