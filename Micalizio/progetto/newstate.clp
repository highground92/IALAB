...
(defrule find_new_state
  ...
  (state (id_state ?id_current_state)(f_cost ?f_cost)(h_cost ?h_cost)(total_distance ?total_distance))
...
=>
  (assert
    (state (id_state (+ ?id_current_state 1))(f_cost ?f_cost)(h_cost ?h_cost)(total_distance ?total_distance))
